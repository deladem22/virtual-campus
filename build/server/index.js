  ...
  return /* @__PURE__ */ jsxs("footer", { className: "container mx-auto py-6 lg:rounded-xl mt-6 bg-zinc-100 dark:bg-neutral-800 lg:mb-4 lg:rounded-xl max-lg:rounded-t-lg max-md:rounded-t-0 max-md:mb-16", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "col-span-2 lg:col-span-1", children: [
        /* @__PURE__ */ jsx("div", { className: "font-bold", children: "GCTU-Vitual Campus" }),
        /* @__PURE__ */ jsx("div", { className: "text-secondary mb-2", children: "An open initiative to promote collaboration and knowledge sharing among students of Ghana Communication & Technology University." }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4 flex-wrap", children: [
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "i-lucide-github" }),
                "Source code"
              ]
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-center text-secondary shrink-0", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-start-3 col-span-1", children: [
        /* @__PURE__ */ jsx("header", { className: "font-bold", children: "final year project" }),
...
function Username({ showVerfied, user }) {
  return /* @__PURE__ */ jsxs("span", { className: "inline-flex gap-1 items-center", children: [
    ...
    user.username === "notgr" && /* @__PURE__ */ jsx("div", { className: "inline-block i-lucide-crown text-amber-500" }),
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsx("header", { className: "container mx-auto border-b border-zinc-200 dark:border-zinc-800 sticky top-0 bg-zinc-50 dark:bg-neutral-900 z-10", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl py-2", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-center", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "font-medium bg-zinc-100 hover:bg-zinc-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 rounded-full p-1 pe-2 transition-[background] duration-200", children: user ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxs(
          NavLink,
          {
            to: `/p/${user.username}`,
        ...
        /* @__PURE__ */ jsx(Link, { to: "/logout", className: "ml-4 p-2 bg-red-500 text-white rounded-lg hover:bg-red-700 transition duration-200", children: "Logout" })
...
const loader$C = async ({ params, request }) => {
...
const meta$q = ({ data }) => {
  ...
  return [
    { title: `Timetable | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
...
const meta$p = ({ data }) => {
  ...
  return [
    {
      title: `@${(_a2 = data == null ? void 0 : data.user) == null ? void 0 : _a2.username} / Communities | ${data == null ? void 0 : data.meta.shortName} ✽ gctu`
    }
  ];
};
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 w-0", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "-mt-3 post-content grid grid-cols-1 lg:grid-cols-4 gap-2", children: [
            showThumbnail && /* @__PURE__ */ jsx("div", { className: "col-span-1 lg:order-last max-lg:mt-2", children: /* @__PURE__ */ jsx("div", { className: "aspect-[3/2]", children: /* @__PURE__ */ jsx(
              "img",
              {
...
const loader$y = async ({ params, request }) => {
...
function ResendVerification() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container min-h-[60vh] mx-auto", children: [
    ...
    school.id === "gctu" && /* @__PURE__ */ jsx(GctuLoginDirection, {})
  ] });
}
...
const meta$m = ({ data }) => {
  return [
    { title: `Edit ${data == null ? void 0 : data.product.name} | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$l = ({ data }) => {
  return [
    { title: `Start a Community | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
...
const meta$k = ({ data }) => {
  ...
  return [
    {
      title: `@${data == null ? void 0 : data.post.user.username} posted in Discussions | ${data == null ? void 0 : data.meta.shortName} ✽ gctu`
    },
...
function AccountCreated() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "container mx-auto h-[60vh]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[24rem] rounded-lg border  bg-white p-4 dark:border-neutral-700 dark:bg-neutral-800", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-2", children: "You may not be able to add or edit content on gctu until you verify your account." }),
    school === "gctu" && /* @__PURE__ */ jsx(GctuLoginDirection, {}),
...
const meta$h = ({ data }) => {
  return [
    { title: `Your Market Profile | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
function MarketProfile() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "container mx-auto min-h-[60vh]", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-4", children: /* @__PURE__ */ jsxs("div", { className: "col-span-1 lg:col-span-3", children: [
    ...
    /* @__PURE__ */ jsx("p", { children: "Set up your market profile to be able to sell on gctu. These details allow customers to identify and reach you." }),
...
async function compare(password, hash2) {
...
const meta$g = ({ data }) => {
  return [{ title: `Create Account | ${data == null ? void 0 : data.school} ✽ gctu` }];
};
...
const meta$e = ({ data }) => {
  return [
    { title: `Notifications | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "notifications",
...
const meta$d = ({ data }) => {
  return [
    { title: `Communities | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$c = ({ data }) => {
  return [
    { title: `Discussions | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$b = ({ data }) => {
  var _a2;
  return [
    { title: `${data == null ? void 0 : data.event.title} | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$9 = ({ data }) => {
  ...
  return [
    { title: `${data == null ? void 0 : data.product.name} | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
      content: data == null ? void 0 : data.product.description
    },
...
const meta$8 = ({ data }) => {
  return [
    { title: `Add Product | Marketplace | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$7 = ({ data }) => {
  var _a2;
  return [
    { title: `@${(_a2 = data == null ? void 0 : data.user) == null ? void 0 : _a2.username} | ${data == null ? void 0 : data.meta.shortName} ✽ gctu` }
  ];
};
const pageLinks = [
  {
...
const meta$6 = ({ data }) => {
  return [{ title: `Timetable | ${data == null ? void 0 : data.school} ✽ gctu` }];
};
function Timetable() {
...
const meta$5 = ({ data }) => {
  return [
    { title: `Library | ${data == null ? void 0 : data.school.shortName} | gctu` },
    {
      name: "description",
...
const meta$4 = ({ data }) => {
  return [
    { title: `Events | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
...
const meta$3 = ({ data }) => {
  return [
    { title: `Marketplace | ${data == null ? void 0 : data.school.shortName} ✽ gctu` },
    {
      name: "description",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container min-h-[60vh]", children: [
    /* @__PURE__ */ jsxs("header", { className: "mb-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
        ...
        /* @__PURE__ */ jsxs(Select, { value: selectedCategory, onChange: handleCategoryChange, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: products.map((product) => /* @__PURE__ */ jsx("div", { className: "col-span-1", children: /* @__PURE__ */ jsx(ProductItem, { product }) }, product.id)) }),
    products.length === 0 && /* @__PURE__ */ jsxs("div", { className: "font-mono text-center text-secondary", children: [
      /* @__PURE__ */ jsx("div", { className: "i-lucide-land-plot inline-block" }),
      " Nothing here!"
    ] })
  ] });
...
const meta$2 = ({ data }) => {
  return [
    { title: `Parlon | ${data == null ? void 0 : data.school.shortName} | gctu` },
    {
      name: "description",
...
function ParlonContent() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container min-h-[60vh]", children: [
    /* @__PURE__ */ jsxs("header", { className: "text-center mb-4", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-secondary leading-tight", children: "Make friends, learn from random people on campus" })
    ] }),
...
const meta$1 = ({ data }) => {
  return [
    { title: `Games | ${data == null ? void 0 : data.school.shortName} | gctu` },
    {
      name: "description",
      content: "Coming soon…"
    }
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BScZ3Dgz.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/module-OGN3If0x.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-DoqFtF2T.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/module-OGN3If0x.js", "/assets/components-BUh_SX-e.js", "/assets/clsx-B-dksMZM.js", "/assets/avatar-CnHNwoiQ.js", "/assets/username-DR9y_VJH.js", "/assets/anchor-BX46IkJD.js"], "css": ["/assets/root-B31jzhWV.css"] }, "routes/downloads.timetable.$year.$programme.$level.$sem": { "id": "routes/downloads.timetable.$year.$programme.$level.$sem", "parentId": "root", "path": "downloads/timetable/:year/:programme/:level/:sem", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/downloads.timetable._year._programme._level._sem-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/timetable_.$year.$programme.$level.$sem.$day.add": { "id": "routes/timetable_.$year.$programme.$level.$sem.$day.add", "parentId": "routes/timetable_.$year.$programme.$level.$sem.$day", "path": "add", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/timetable_._year._programme._level._sem._day.add-Dm0HiZCl.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/index.esm-eIWaUr6p.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/days-DkqQ87fy.js", "/assets/time-2AcYv75b.js", "/assets/large-select-D1kH_rXC.js", "/assets/button-D3-ocrTF.js"], "css": [] }, "routes/timetable_.$year.$programme.$level.$sem.$day": { "id": "routes/timetable_.$year.$programme.$level.$sem.$day", "parentId": "root", "path": "timetable/:year/:programme/:level/:sem/:day", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/timetable_._year._programme._level._sem._day-DH_Um4lb.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/index.esm-eIWaUr6p.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/large-select-D1kH_rXC.js", "/assets/select-D6U1yScx.js", "/assets/module-OGN3If0x.js", "/assets/days-DkqQ87fy.js", "/assets/time-2AcYv75b.js", "/assets/button-D3-ocrTF.js", "/assets/timetable-filter-BF_zBXoc.js", "/assets/anchor-BX46IkJD.js"], "css": [] }, "routes/communities_.$slug.members": { "id": "routes/communities_.$slug.members", "parentId": "routes/communities_.$slug", "path": "members", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities_._slug.members-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/p.$username.communities": { "id": "routes/p.$username.communities", "parentId": "routes/p.$username", "path": "communities", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/p._username.communities-BOC7QHcE.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/avatar-CnHNwoiQ.js", "/assets/ellipsize-CD66mNIP.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/communities_.$slug.mod": { "id": "routes/communities_.$slug.mod", "parentId": "routes/communities_.$slug", "path": "mod", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities_._slug.mod-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/manifest[.]webmanifest": { "id": "routes/manifest[.]webmanifest", "parentId": "root", "path": "manifest.webmanifest", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/manifest_._webmanifest-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/communities_.created": { "id": "routes/communities_.created", "parentId": "root", "path": "communities/created", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities_.created-NKg330Ir.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/anchor-BX46IkJD.js"], "css": [] }, "routes/downloads.events.$id": { "id": "routes/downloads.events.$id", "parentId": "root", "path": "downloads/events/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/downloads.events._id-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/discussions_.$id_.$": { "id": "routes/discussions_.$id_.$", "parentId": "root", "path": "discussions/:id/*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/discussions_._id_._-Y0CH1Qqc.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/index-BqmKY8Xa.js", "/assets/components-BUh_SX-e.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/post-time-BzanNHiO.js", "/assets/file-input-AkW8SXRP.js", "/assets/avatar-CnHNwoiQ.js", "/assets/index-DliEd2f6.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/textarea-D9GvzXla.js", "/assets/username-DR9y_VJH.js", "/assets/post-item-FZu80jFJ.js", "/assets/post-content-DCVJd60A.js"], "css": [] }, "routes/p.$username.catalog": { "id": "routes/p.$username.catalog", "parentId": "routes/p.$username", "path": "catalog", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/p._username.catalog-CJICKe-5.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/components-BUh_SX-e.js", "/assets/product-item-BHXp-zgo.js"], "css": [] }, "routes/resend-verification": { "id": "routes/resend-verification", "parentId": "root", "path": "resend-verification", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/resend-verification-DYxYeyEv.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/gctu-login-direction-C7rwEuvj.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/communities_.$slug": { "id": "routes/communities_.$slug", "parentId": "root", "path": "communities/:slug", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities_._slug-NbQy8Ku2.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/post-time-BzanNHiO.js", "/assets/file-input-AkW8SXRP.js", "/assets/avatar-CnHNwoiQ.js", "/assets/index-DliEd2f6.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/textarea-D9GvzXla.js", "/assets/username-DR9y_VJH.js", "/assets/anchor-BX46IkJD.js", "/assets/post-item-FZu80jFJ.js"], "css": [] }, "routes/notifications_.$id": { "id": "routes/notifications_.$id", "parentId": "root", "path": "notifications/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/notifications_._id-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/market_.$id_.edit": { "id": "routes/market_.$id_.edit", "parentId": "root", "path": "market/:id/edit", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/market_._id_.edit-4Thbtfsw.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/file-input-AkW8SXRP.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/select-D6U1yScx.js", "/assets/textarea-D9GvzXla.js", "/assets/components-BUh_SX-e.js", "/assets/product-form-dIfkr0-a.js"], "css": [] }, "routes/communities_.new": { "id": "routes/communities_.new", "parentId": "root", "path": "communities/new", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities_.new-xaollEY4.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/textarea-D9GvzXla.js", "/assets/username-regex-D55r8JyB.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/discussions_.$id": { "id": "routes/discussions_.$id", "parentId": "root", "path": "discussions/:id", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/discussions_._id-C7uH0LMJ.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/index-BqmKY8Xa.js", "/assets/components-BUh_SX-e.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/post-time-BzanNHiO.js", "/assets/file-input-AkW8SXRP.js", "/assets/avatar-CnHNwoiQ.js", "/assets/index-DliEd2f6.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/textarea-D9GvzXla.js", "/assets/username-DR9y_VJH.js", "/assets/post-item-FZu80jFJ.js", "/assets/post-content-DCVJd60A.js"], "css": [] }, "routes/account-created": { "id": "routes/account-created", "parentId": "root", "path": "account-created", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/account-created-DyZXxkEV.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/gctu-login-direction-C7rwEuvj.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/forgot-password": { "id": "routes/forgot-password", "parentId": "root", "path": "forgot-password", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/forgot-password-DKAHZ5Ic.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/gctu-login-direction-C7rwEuvj.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/market_.profile": { "id": "routes/market_.profile", "parentId": "root", "path": "market/profile", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/market_.profile-DZUTN692.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/create-account": { "id": "routes/create-account", "parentId": "root", "path": "create-account", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/create-account-L-V-KwLg.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/username-regex-D55r8JyB.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/reset-password": { "id": "routes/reset-password", "parentId": "root", "path": "reset-password", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/reset-password-BpW2BDHs.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/notifications": { "id": "routes/notifications", "parentId": "root", "path": "notifications", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/notifications-D1xPUAUx.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/index-DliEd2f6.js", "/assets/post-time-BzanNHiO.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/library_.$id": { "id": "routes/library_.$id", "parentId": "root", "path": "library/:id", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/library_._id-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/verify-email": { "id": "routes/verify-email", "parentId": "root", "path": "verify-email", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/verify-email-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/communities": { "id": "routes/communities", "parentId": "root", "path": "communities", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/communities-BL-M5lp0.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/anchor-BX46IkJD.js", "/assets/avatar-CnHNwoiQ.js", "/assets/ellipsize-CD66mNIP.js"], "css": [] }, "routes/discussions": { "id": "routes/discussions", "parentId": "root", "path": "discussions", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/discussions-CoXUTd59.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/components-BUh_SX-e.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/post-time-BzanNHiO.js", "/assets/file-input-AkW8SXRP.js", "/assets/avatar-CnHNwoiQ.js", "/assets/index-DliEd2f6.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/textarea-D9GvzXla.js", "/assets/username-DR9y_VJH.js", "/assets/post-item-FZu80jFJ.js", "/assets/tags-filter-DyefsU8y.js"], "css": [] }, "routes/events_.$id": { "id": "routes/events_.$id", "parentId": "root", "path": "events/:id", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/events_._id-DWD-a1N7.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/anchor-BX46IkJD.js", "/assets/button-D3-ocrTF.js", "/assets/post-time-BzanNHiO.js", "/assets/username-DR9y_VJH.js", "/assets/time-2AcYv75b.js"], "css": [] }, "routes/events_.add": { "id": "routes/events_.add", "parentId": "root", "path": "events/add", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/events_.add-DHn4onjb.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/file-input-AkW8SXRP.js", "/assets/input-DaKQDKVv.js", "/assets/textarea-D9GvzXla.js", "/assets/time-2AcYv75b.js", "/assets/index-BqmKY8Xa.js"], "css": [] }, "routes/instructors": { "id": "routes/instructors", "parentId": "root", "path": "instructors", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/instructors-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/lessons.$id": { "id": "routes/lessons.$id", "parentId": "root", "path": "lessons/:id", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/lessons._id-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/market_.$id": { "id": "routes/market_.$id", "parentId": "root", "path": "market/:id", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/market_._id-D_-zeX8l.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/anchor-BX46IkJD.js", "/assets/button-D3-ocrTF.js", "/assets/username-DR9y_VJH.js"], "css": [] }, "routes/market_.add": { "id": "routes/market_.add", "parentId": "root", "path": "market/add", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/market_.add-9xwSA390.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/file-input-AkW8SXRP.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/select-D6U1yScx.js", "/assets/textarea-D9GvzXla.js", "/assets/components-BUh_SX-e.js", "/assets/product-form-dIfkr0-a.js"], "css": [] }, "routes/p.$username": { "id": "routes/p.$username", "parentId": "root", "path": "p/:username", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/p._username-4ceUesxz.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/components-BUh_SX-e.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/post-time-BzanNHiO.js", "/assets/file-input-AkW8SXRP.js", "/assets/avatar-CnHNwoiQ.js", "/assets/index-DliEd2f6.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/textarea-D9GvzXla.js", "/assets/username-DR9y_VJH.js", "/assets/post-item-FZu80jFJ.js"], "css": [] }, "routes/parlon.call": { "id": "routes/parlon.call", "parentId": "routes/parlon", "path": "call", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/parlon.call-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/programmes": { "id": "routes/programmes", "parentId": "root", "path": "programmes", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/programmes-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/vote.$post": { "id": "routes/vote.$post", "parentId": "root", "path": "vote/:post", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/vote._post-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/timetable": { "id": "routes/timetable", "parentId": "root", "path": "timetable", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/timetable-CjVLYm5f.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/index.esm-eIWaUr6p.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/large-select-D1kH_rXC.js", "/assets/select-D6U1yScx.js", "/assets/timetable-filter-BF_zBXoc.js"], "css": [] }, "routes/comments": { "id": "routes/comments", "parentId": "root", "path": "comments", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/comments-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/courses": { "id": "routes/courses", "parentId": "root", "path": "courses", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/courses-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/library": { "id": "routes/library", "parentId": "root", "path": "library", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/library-BGx63R-l.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/components-BUh_SX-e.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/modal-BvqMTZsz.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/tag-select-pFlWs3Bt.js", "/assets/index.esm-eIWaUr6p.js", "/assets/file-input-AkW8SXRP.js", "/assets/post-time-BzanNHiO.js", "/assets/tags-filter-DyefsU8y.js", "/assets/username-DR9y_VJH.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/events": { "id": "routes/events", "parentId": "root", "path": "events", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/events-Df5CJzre.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/dayjs.min-DReL-Uwu.js", "/assets/anchor-BX46IkJD.js", "/assets/post-time-BzanNHiO.js", "/assets/username-DR9y_VJH.js", "/assets/time-2AcYv75b.js"], "css": [] }, "routes/logout": { "id": "routes/logout", "parentId": "root", "path": "logout", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/logout-CSxRPO1x.js", "imports": [], "css": [] }, "routes/market": { "id": "routes/market", "parentId": "root", "path": "market", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/market-BNUJLXcC.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/anchor-BX46IkJD.js", "/assets/input-DaKQDKVv.js", "/assets/product-item-BHXp-zgo.js", "/assets/select-D6U1yScx.js"], "css": [] }, "routes/parlon": { "id": "routes/parlon", "parentId": "root", "path": "parlon", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/parlon-5wO_rUrx.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/index-BqmKY8Xa.js", "/assets/clsx-B-dksMZM.js", "/assets/components-BUh_SX-e.js", "/assets/anchor-BX46IkJD.js", "/assets/button-D3-ocrTF.js"], "css": [] }, "routes/people": { "id": "routes/people", "parentId": "root", "path": "people", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/people-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/games": { "id": "routes/games", "parentId": "root", "path": "games", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/games-BTjck6Ww.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js"], "css": [] }, "routes/login": { "id": "routes/login", "parentId": "root", "path": "login", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/login-BYH9-j7q.js", "imports": ["/assets/jsx-runtime-CAOzMBF_.js", "/assets/clsx-B-dksMZM.js", "/assets/index-BqmKY8Xa.js", "/assets/index.esm-eIWaUr6p.js", "/assets/button-D3-ocrTF.js", "/assets/input-DaKQDKVv.js", "/assets/components-BUh_SX-e.js"], "css": [] }, "routes/media": { "id": "routes/media", "parentId": "root", "path": "media", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/media-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/md": { "id": "routes/md", "parentId": "root", "path": "md", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/md-l0sNRNKZ.js", "imports": [], "css": [] } }, "url": "/assets/manifest-a433436d.js", "version": "a433436d" };
